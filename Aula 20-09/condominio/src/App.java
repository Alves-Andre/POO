    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true){
            ...
            switch(opcao){
                ...
                retornaUnidadesDisponives(ambience);
                ...
                case "3":
                System.out.println("Digite o número do apartamento que você deseja saber as informaçÕes");
                String escolhaap = teclado.next();
                ambience.visualizarApto(escolhaap);
                break;
            }
        }
    }

    private static void retornaUnidadesDisponives(Condominio ambience) {
